	...
	<div class="content-wrapper">
		<div class="content-header">
			<div class="container-fluid">
				...
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0">Report <?= strtoupper(substr($id, 0, 1) . "-" . substr($id, 1, 2)) ?></h1>
					</div>
					<div class="col-sm-6">
		...
		<div class="content">
			<div class="container-fluid">
				<div class="row">
					<div class="col-12">
						<form method="post" action="<?= base_url() . 'report/search' ?>">
							<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
							<div class="d-flex filter-list">
								<div class="form-group">
									<label for="">From</label>
									<div class="input-group date" id="fromdate" data-target-input="nearest">
										<input type="text" class="form-control datetimepicker-input" data-target="#fromdate" name="i_fromdate" />
								...
								<div class="form-group">
									...
									<div class="input-group date" id="todate" data-target-input="nearest">
										<input type="text" class="form-control datetimepicker-input" data-target="#todate" name="i_todate" />
								...
								<!-- <div class="form-group">
									<label>&nbsp;</label><br>
									<button type="button" class="btn btn-primary d-block" data-toggle="modal" data-target="modal-change">Select Equipment</button>
								</div> -->
							</div>
						</form>
					</div>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										<label for="company">Device</label>
										<select autofocus="" id="device" name="device" class="form-control device-dropdown">
							...
							<div class="table-responsive">
								<table class="table table-bordered" id="datatable">
									...
									<tbody>
										<?php 
											foreach ($log_table as $key => $value) { 
										?>	
											<tr>
												<td></td>
...
<script>
	$(document).ready(function() {
		...
		$('.device-dropdown').on('change', function(e){
			device = $(this).val();
			$('.device-dropdown').val(device)
			if(device == "all") device = "";
			t.column(4).search(device).draw();
		})
...
<script>
	var from_dateNow = new Date('<?= $from_date ?>');
	var to_dateNow = new Date('<?= $to_date ?>');
